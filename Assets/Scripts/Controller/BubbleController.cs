...
namespace com.javierquevedo
{
    public class BubbleController : MonoBehaviour
    {
		...
		*/
        ...
        /* Constants */
        private float _killSpeedMax = 15f;
        private float _killSpeedMin = 25f;
        ...
        void Awake()
        {
            bubble = new Bubble(JQUtils.GetRandomEnum<BubbleColor>(), 0);
        ...
        public void kill(bool explodes)
        {
            ...
            else //drop them down
            {
                ...
                this.moveTo(killPosition, distance / Random.Range(_killSpeedMin, _killSpeedMax));
            }
        }
